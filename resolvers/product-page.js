 ...
 * 
 * Universal resolver for product listing pages with optional category context.
 ...
 * 
 * NOTE: Unlike category-page, this resolver works without a required category
 */
    ...
    Query: {
      Citisignal_productPageData: async (root, args, context, info) => {
        try {
          ...
          // Category is optional for product page (can show all products)
          ...
          console.error('Error in Citisignal_productPageData:', error.message);
